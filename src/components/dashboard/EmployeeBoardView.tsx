            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
                <div className="space-y-2">
                    <div className="flex items-center gap-3">
                        <div className="px-2.5 py-0.5 rounded-full bg-brand-blue/10 text-brand-blue text-[8px] font-bold tracking-widest uppercase border border-brand-blue/10">
                            Command Center
                        </div>
                    ...
                    <p className="text-xs text-slate-500 font-medium max-w-2xl">
                        ...
                        Efficiency: <span className="text-brand-blue font-bold">{Math.round(efficiencyPercentage)}%</span>.
                    </p>
                </div>
            ...
            <div className="flex items-center justify-between px-2 mb-4">
                <div className="flex items-center gap-2">
                    <div className={cn(
                        ...
                        title.includes('To Do') ? 'bg-brand-blue' : 
                            ...
                            >
                                <div className="space-y-3">
                                    ...
                                    {editingTaskId === task.id ? (
                                            ...
                                            <div className="flex flex-wrap items-center gap-1.5">
                                                ...
                                                <div className="flex gap-1 ml-auto">
                                                    <button 
                                                        ...
                                                        className="p-1 bg-brand-blue text-white rounded-md hover:bg-brand-blue-dark transition-colors"
                                                    >
                                        ...
                                        <h4 className="text-[13px] font-bold text-slate-800 leading-snug tracking-tight group-hover:text-brand-blue transition-colors line-clamp-2 flex items-center justify-between gap-2">
                                            {task.name}
                                            <button 
                                                onClick={(e) => { 
                                                    e.stopPropagation(); 
            ...
            {activeTab === 'mine' ? (
                <div className="fade-in h-[calc(100vh-200px)] flex flex-col">
                    <div className="flex items-center justify-between mb-5 shrink-0">
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-brand-blue/10 flex items-center justify-center text-brand-blue"><Zap size={18} strokeWidth={2.5} /></div>
                ...
                <div className="max-w-4xl mx-auto fade-in pb-6">
                    <Card className="bg-gradient-to-br from-brand-blue to-[#00c6ff] border-none mb-5 p-5 text-white">
