            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
                <div className="space-y-2">
                    <div className="flex items-center gap-3">
                        <div className="px-2.5 py-0.5 rounded-full bg-[#0051e6]/10 text-[#0051e6] text-[8px] font-bold tracking-widest uppercase border border-[#0051e6]/10">
                            Command Center
                        </div>
                    ...
                    <p className="text-xs text-slate-500 font-medium max-w-2xl">
                        ...
                        Efficiency: <span className="text-[#0051e6] font-bold">{Math.round(efficiencyPercentage)}%</span>.
                    </p>
                </div>
        ...
        >
            <div className="lg:col-span-2 space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <Card className="p-6 bg-white border-[#f0f0f2] rounded-[24px] shadow-sm">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 rounded-xl bg-[#0051e6]/10 flex items-center justify-center text-[#0051e6] shadow-sm"><Activity size={18} /></div>
                            <div>
                        ...
                        <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                            <motion.div 
                                ...
                                className="h-full bg-[#0051e6] rounded-full"
                            />
                        </div>
                    </Card>
                </div>
                ...
                <Card className="p-8 bg-white border-[#f0f0f2] rounded-[24px] shadow-sm">
                    <h4 className="text-[10px] font-bold text-[#1d1d1f] uppercase tracking-widest mb-8 flex items-center gap-2">
                        <Zap size={14} className="text-[#0051e6]" />
            ...
            <div className="space-y-6">
                <Card className="p-8 bg-[#1d1d1f] text-white border-none rounded-[24px] shadow-xl relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#0051e6] rounded-full blur-[60px] opacity-20 group-hover:opacity-30 transition-opacity duration-700" />
            ...
            <div className="flex items-center justify-between px-2 mb-4">
                <div className="flex items-center gap-2">
                    <div className={cn(
                        ...
                        title.includes('To Do') ? 'bg-[#0051e6]' : 
                            ...
                            >
                                <div className="space-y-3">
                                    ...
                                    {editingTaskId === task.id ? (
                                            ...
                                            <div className="flex flex-wrap items-center gap-1.5">
                                                ...
                                                <div className="flex gap-1 ml-auto">
                                                    <button 
                                                        ...
                                                        className="p-1 bg-[#0051e6] text-white rounded-md hover:bg-[#005bb7] transition-colors"
                                                    >
                                        ...
                                        <h4 className="text-[13px] font-bold text-slate-800 leading-snug tracking-tight group-hover:text-[#0051e6] transition-colors line-clamp-2 flex items-center justify-between gap-2">
                                            {task.name}
                                            <button 
                                                onClick={(e) => { 
                                                    e.stopPropagation(); 
                                                ...
                                                className="opacity-0 group-hover:opacity-100 text-slate-300 hover:text-[#0051e6] transition-all p-1 hover:bg-[#0051e6]/5 rounded-md"
                                            >
                                    ...
                                    <div className="space-y-2.5">
                                        ...
                                        <div className="h-1.5 w-full bg-slate-50 rounded-full overflow-hidden border border-slate-100/50">
                                            <motion.div 
                                                ...
                                                className="h-full bg-gradient-to-r from-[#0051e6] to-[#00c6ff] rounded-full transition-all duration-1000"
                                            />
                                        </div>
                                    </div>
                                        ...
                                        <div className="flex items-center gap-4 text-[10px] font-bold text-slate-400">
                                            {totalHours > 0 && (
                                                <div className="flex items-center gap-1.5 group-hover:text-slate-600 transition-colors">
                                                    ...
                                                    <span className="tabular-nums">{Math.round(totalHours * 10) / 10}h</span>
                                                </div>
                                            )}
                                            <div className="flex items-center gap-1.5 group-hover:text-slate-600 transition-colors">
            ...
            {activeTab === 'mine' ? (
                <div className="fade-in h-[calc(100vh-200px)] flex flex-col">
                    <div className="flex items-center justify-between mb-5 shrink-0">
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-[#0051e6]/10 flex items-center justify-center text-[#0051e6]"><Zap size={18} strokeWidth={2.5} /></div>
                ...
                <div className="max-w-4xl mx-auto fade-in pb-6">
                    <Card className="bg-gradient-to-br from-[#0051e6] to-[#00c6ff] border-none mb-5 p-5 text-white">
