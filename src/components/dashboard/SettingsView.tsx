            ...
            <div className="flex items-center gap-6 mb-10 pb-8 border-b border-[#f0f0f2]">
                <div className="relative group shrink-0">
                    <UserAvatar
                        ...
                        avatarUrl={avatarUrl}
                        className="w-16 h-16 rounded-2xl bg-brand-blue shadow-sm"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {[
                                ...
                                <Link
                                    key={item.href}
                                    href={item.href}
                                    className="group flex items-center gap-3 p-3 rounded-xl border border-[#eceef0] bg-white hover:border-brand-blue/30 hover:bg-brand-blue/3 transition-colors"
                                >
                                    <div className="w-8 h-8 rounded-lg bg-[#f5f5f7] flex items-center justify-center text-[#1d1d1f] group-hover:bg-brand-blue/10 group-hover:text-brand-blue transition-colors">
                                        {item.icon}
                                    </div>
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-4">
                        <div className="space-y-1.5">
                            ...
                            <input 
                                ...
                                className="w-full h-10 rounded-xl bg-[#f5f5f7] border-none px-5 text-[11px] font-bold outline-none focus:ring-1 ring-brand-blue" 
                            />
                        </div>
                        <button 
                            type="submit" 
