            ...
            <div className="flex items-center gap-6">
                ...
                <div className="relative group hidden sm:block">
                    ...
                    <input 
                        ...
                        className="pl-9 pr-4 py-2 bg-[#f5f5f7] border-none rounded-xl text-[10px] font-black text-[#1d1d1f] w-48 lg:w-64 focus:ring-2 focus:ring-[#0071e3]/20 transition-all outline-none" 
                    />
                </div>
                        ...
                        <div className="absolute right-0 mt-3 w-80 bg-white rounded-3xl shadow-2xl border border-[#e5e5ea] z-50 overflow-hidden fade-in">
                            <div className="p-5 border-b border-[#f5f5f7] flex justify-between items-center bg-[#f5f5f7]/50">
                                ...
                                <button 
                                    ...
                                    className="text-[9px] font-black text-[#0071e3] uppercase tracking-widest hover:underline"
                                >
                                    Clear All
                                </button>
                            </div>
                                ...
                                {notifications.length === 0 ? (
                                    ...
                                    notifications.map(n => (
                                        <div 
                                            ...
                                            className={`p-4 border-b border-[#f5f5f7] hover:bg-[#f5f5f7] cursor-pointer transition-colors ${!n.is_read ? 'bg-[#0071e3]/5 font-bold' : ''}`}
                                        >
                                            <div className="flex gap-3">
                                                <div className={`mt-1.5 w-1.5 h-1.5 rounded-full shrink-0 ${n.type === 'urgent' ? 'bg-[#ff3b30]' : 'bg-[#0071e3]'}`} />
