    ...
    return (
        <header className="h-16 bg-white/80 backdrop-blur-md border-b border-[#e5e5ea] flex items-center justify-between px-6 lg:px-8 sticky top-0 z-[40] shrink-0">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <div className="text-[11px] font-bold text-[#6b6b73] uppercase tracking-[0.2em] mb-1 flex items-center gap-2">
            ...
            <div className="flex items-center gap-4">
                <div className="relative group hidden sm:block">
                    <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none text-[#6b6b73]"><Search size={14} strokeWidth={3} /></div>
                    <input 
                        type="text" 
                        placeholder="Search..." 
                        value={searchQuery} 
                        onChange={(e) => setSearchQuery(e.target.value)} 
                        className="pl-10 pr-4 py-2 bg-[#f5f5f7] border-none rounded-2xl text-[11px] font-bold text-[#1d1d1f] w-40 lg:w-64 focus:ring-2 focus:ring-brand-blue/20 transition-colors outline-none" 
                    />
                </div>
                <div className="relative" ref={notificationRef}>
                    <button onClick={() => setShowNotifications(!showNotifications)} className="p-2.5 bg-[#f5f5f7] hover:bg-[#e5e5ea] text-[#1d1d1f] rounded-2xl transition-colors relative">
