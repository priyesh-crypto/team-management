            ...
            <div className="flex items-center gap-4">
                <div className="relative group hidden sm:block">
                    ...
                    <input 
                        ...
                        className="pl-10 pr-4 py-2 bg-[#f5f5f7] border-none rounded-2xl text-[11px] font-bold text-[#1d1d1f] w-40 lg:w-64 focus:ring-2 focus:ring-[#0071e3]/20 transition-all outline-none" 
                    />
                </div>
                        ...
                        <div className="absolute right-0 mt-3 w-[calc(100vw-32px)] sm:w-80 bg-white rounded-3xl shadow-2xl border border-[#e5e5ea] z-50 overflow-hidden fade-in">
                            <div className="p-5 border-b border-[#f5f5f7] flex justify-between items-center bg-[#f5f5f7]/50">
                                ...
                                <button 
                                    ...
                                    className="text-[10px] font-bold text-[#0071e3] uppercase tracking-tighter"
                                >
                                    Mark all read
                                </button>
                            </div>
                                    ...
                                    notifications.map(n => (
                                        ...
                                        >
                                            <div className="flex gap-3">
                                                <div className={`mt-1 w-2 h-2 rounded-full shrink-0 ${n.type === 'urgent' ? 'bg-[#ff3b30]' : 'bg-[#0071e3]'}`} />
