                                        ...
                                        return (
                                            <td key={dateKey} className="py-1 px-1">
                                                ...
                                                >
                                                    ...
                                                    {isToday && (
                                                        <div className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-brand-blue rounded-full border-2 border-white shadow-sm" />
                                                    )}
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-4">
                                <UserAvatar
                                    ...
                                    className="w-12 h-12 rounded-[20px] bg-brand-blue shadow-lg shadow-brand-blue/20"
