        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-sm w-full mx-4 relative">
                ...
                <p className="text-sm text-slate-500 text-center leading-relaxed mb-6">
                    ...
                    <span className="font-black text-brand-blue">{tier} plan</span>.
                    Upgrade to keep your team moving faster.
                </p>

                <a
                    href="/dashboard/settings/billing"
                    className="block w-full text-center px-6 py-3 rounded-xl bg-brand-blue text-white text-sm font-black hover:bg-brand-blue-dark transition-colors"
                >
                    Upgrade to {tier}
                </a>
                <button
