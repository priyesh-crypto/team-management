...
export function AISummaryWidget({ initialSummaries }: Props) {
    ...
    return (
        <UpgradeGate feature="ai_weekly_summary">
            <div className="bg-gradient-to-br from-brand-blue/5 to-[#7c3aed]/5 rounded-2xl border border-brand-blue/10 overflow-hidden">
                <div className="flex items-center justify-between px-5 py-4">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-brand-blue to-[#7c3aed] flex items-center justify-center">
                ...
                {expanded && latest && (
                    <div className="px-5 pb-5">
                        ...
                        <div className="grid grid-cols-4 gap-3 mb-4">
                            {[
                                { label: "New", value: latest.stats_snapshot.new_tasks, color: "text-brand-blue" },
