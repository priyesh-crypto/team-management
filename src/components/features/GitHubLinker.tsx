    ...
    return (
        <UpgradeGate feature="github_integration">
            <div className="space-y-3">
                ...
                {!connection?.is_active && (
                    <div className="text-xs text-slate-400 py-2">GitHub not connected. Configure in <a href="/dashboard/settings/integrations" className="text-brand-blue hover:underline">Integrations</a>.</div>
                )}
                        ...
                        <div key={link.id} className="flex items-center gap-2 group py-1">
                            ...
                            {link.url && (
                                <a href={link.url} target="_blank" rel="noopener noreferrer"
                                    className="p-1 rounded text-slate-300 hover:text-brand-blue transition-colors">
