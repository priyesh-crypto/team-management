                    ...
                    {!generated ? (
                        <div className="text-center py-8">
                            ...
                            <button
                                onClick={generate}
                                disabled={loading}
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-blue text-white text-sm font-black hover:bg-brand-blue-dark disabled:opacity-50 transition-colors"
                            >
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <button
                                    onClick={generate}
                                    disabled={loading}
                                    className="text-[11px] font-black text-brand-blue hover:underline disabled:opacity-50"
                                >
                                    Regenerate
                                </button>
                            </div>
                                ...
                                {suggestions.map((s, i) => (
                                    ...
                                    >
                                        <div className={`w-5 h-5 rounded-md flex-shrink-0 flex items-center justify-center mt-0.5 transition-colors ${
                                            selected.has(i) ? "bg-brand-blue text-white" : "border border-slate-200"
                                        }`}>
                    ...
                    <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-brand-blue text-white text-sm font-black disabled:opacity-50 hover:bg-brand-blue-dark transition-colors"
                            >
    ...
    return (
        <UpgradeGate feature="ai_breakdown">
            <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-brand-blue to-[#7c3aed] text-white text-[11px] font-black hover:opacity-90 transition-opacity shadow-sm"
            >
                <Sparkles size={12} />
                AI breakdown
            </button>
