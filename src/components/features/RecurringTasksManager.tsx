        ...
        <form onSubmit={handleSubmit} className="space-y-3 p-4 bg-slate-50 rounded-2xl border border-slate-200">
            <div>
                ...
                <input
                    ...
                    className="mt-1 w-full px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-blue/20"
                    required
                />
            </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-brand-blue text-white text-[11px] font-black hover:bg-brand-blue-dark transition-colors"
                    >
                        <Plus size={12} />
                        New template
                    </button>
