...
function FieldInput({ def, value, onChange }: {
    ...
    const inputClass = "w-full px-3 py-2 rounded-xl border border-slate-200 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-blue/20";
                        ...
                        return (
                            <button
                                ...
                                className={`px-2.5 py-1 rounded-lg text-[11px] font-bold border transition-colors ${
                                    selected ? "bg-brand-blue text-white border-brand-blue" : "border-slate-200 text-slate-600 hover:border-brand-blue/30"
                                }`}
                            >
                                {opt}
                            </button>
                ...
                {showAddField && (
                    <form onSubmit={handleAddField} className="space-y-3 p-4 bg-slate-50 rounded-xl border border-slate-200">
                        ...
                        <div className="flex gap-2">
                            <button type="submit" disabled={pending} className="flex-1 px-3 py-2 rounded-lg bg-brand-blue text-white text-[11px] font-black disabled:opacity-50">
