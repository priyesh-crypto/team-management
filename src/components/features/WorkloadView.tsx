                                ...
                                {dates.map(d => {
                                    ...
                                    return (
                                        <th key={ds} className={`px-1 py-2 text-center min-w-[44px] ${isWeekend ? "bg-slate-50" : ""}`}>
                                            <div className={`text-[9px] font-black ${isToday ? "text-brand-blue" : "text-slate-400"}`}>
                                                {d.toLocaleDateString("en", { weekday: "short" })}
                                            </div>
                                            <div className={`text-[10px] font-black mt-0.5 ${isToday ? "text-brand-blue" : "text-slate-500"}`}>
                                                {d.getDate()}
                                            </div>
                                        </th>
                                    );
                                    ...
                                    <td className="px-5 py-2 sticky left-0 bg-white">
                                        <div className="flex items-center gap-2">
                                            {member.avatar_url ? (
                                                ...
                                                <div className="w-6 h-6 rounded-full bg-brand-blue/10 flex items-center justify-center text-[9px] font-black text-brand-blue flex-shrink-0">
