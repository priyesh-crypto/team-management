    ...
    return (
        <UpgradeGate feature="saved_views">
            <div className="relative">
                ...
                >
                    <Bookmark size={12} />
                    Views {views.length > 0 && <span className="ml-0.5 text-brand-blue">({views.length})</span>}
                </button>
                        ...
                        {showSave && (
                            <form onSubmit={handleSave} className="p-3 border-b border-slate-100 space-y-2">
                                <input
                                    ...
                                    autoFocus
                                    className="w-full px-3 py-2 text-[12px] font-bold rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-blue/20"
                                />
                                ...
                                <div className="flex gap-2">
                                    <button type="submit" disabled={pending} className="flex-1 px-3 py-1.5 rounded-xl bg-brand-blue text-white text-[11px] font-black disabled:opacity-50">
                                        {pending ? "Saving…" : "Save"}
                                    </button>
