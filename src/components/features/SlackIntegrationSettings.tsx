                        ...
                        <form onSubmit={handleSave} className="space-y-4">
                            <div>
                                <label className="text-[11px] font-black text-slate-500 uppercase tracking-wider block mb-1.5">
                                    ...
                                    <a
                                        ...
                                        className="ml-1.5 text-brand-blue inline-flex items-center gap-0.5"
                                    >
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2.5 rounded-xl border border-slate-200 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-blue/20"
                                    required
                                />
                            </div>
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    type="submit"
                                    disabled={saving}
                                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-brand-blue text-white text-sm font-black hover:bg-brand-blue-dark disabled:opacity-50 transition-colors"
                                >
