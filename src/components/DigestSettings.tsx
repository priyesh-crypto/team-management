    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center p-12">
                <Loader2 className="w-6 h-6 animate-spin text-[#0051e6]" />
            </div>
        );
    }
            ...
            <div className="bg-[#f5f5f7] rounded-3xl p-8 border border-[#e5e5ea]/50">
                <div className="flex items-start gap-4 mb-8">
                    <div className="p-3 bg-white rounded-2xl shadow-sm border border-[#e5e5ea]">
                        <Bell className="w-5 h-5 text-[#0051e6]" />
                    </div>
                    <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            {(['email', 'slack', 'both', 'none'] as const).map(c => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        prefs.channel === c
                                            ? "bg-white border-[#0051e6] text-[#0051e6] shadow-md"
                    ...
                    {(prefs.channel === 'slack' || prefs.channel === 'both') && (
                        <div className="space-y-4 animate-in zoom-in-95 duration-300">
                            ...
                            <input
                                ...
                                className="w-full bg-white border border-[#e5e5ea] rounded-2xl px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-[#0051e6]/20 focus:border-[#0051e6] transition-all"
                            />
                        </div>
                    )}
                    ...
                    <div className="space-y-4">
                        ...
                        <select
                            ...
                            className="w-full bg-white border border-[#e5e5ea] rounded-2xl px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-[#0051e6]/20 focus:border-[#0051e6] transition-all appearance-none cursor-pointer"
                        >
