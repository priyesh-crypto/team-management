        ...
        <div className="p-10 max-w-7xl space-y-6">
            ...
            <Card className="border-red-100">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between flex-wrap gap-3 pb-4 border-b border-[#f5f5f7]">
                        <div>
                            <p className="text-sm font-bold text-[#1d1d1f]">Cancel subscription</p>
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <Card className="w-[520px] max-w-full !border-red-200">
                        <div className="flex items-start gap-3 mb-4">
                            <div className="w-10 h-10 rounded-xl bg-red-50 text-red-600 flex items-center justify-center text-xl flex-shrink-0">
                                ⚠️
                            </div>
                            <div>
                                <h3 className="text-lg font-black tracking-tight text-[#1d1d1f]">
                        ...
                        <div className="bg-red-50/50 rounded-xl p-3 mb-4 space-y-1 text-xs text-red-900">
