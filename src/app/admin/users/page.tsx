            ...
            <form method="GET" action="/admin/users">
                <div className="flex gap-3">
                    <input
                        ...
                        autoFocus
                        className="flex-1 px-4 py-3 rounded-2xl border border-[#e5e5ea] text-sm font-medium focus:outline-none focus:ring-2 focus:ring-brand-blue/20 bg-white"
                    />
                    <button
                        type="submit"
                        className="px-5 py-3 rounded-2xl bg-brand-blue text-white text-sm font-black hover:bg-brand-blue-dark transition-colors"
                    >
                        Search
                    </button>
                </div>
