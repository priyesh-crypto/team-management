            ...
            <PageHeader
                ...
                actions={
                    <Link
                        ...
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-md bg-brand-blue text-white text-sm font-medium hover:bg-[#0950c4] transition-colors"
                    >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-1.5 flex-wrap">
                                            ...
                                            {(b.channels as string[]).map(ch => (
                                                <span key={ch} className="px-2 py-0.5 rounded-full bg-brand-blue/10 text-brand-blue text-[11px] font-medium capitalize">
                                                    {ch}
                                                </span>
                                            ))}
                                        </div>
