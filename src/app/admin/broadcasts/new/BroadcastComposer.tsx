                ...
                <div className="space-y-3">
                    ...
                    <Field label="Body">
                        <textarea
                            ...
                            className="w-full px-3 py-2.5 rounded-xl border border-[#e5e5ea] text-sm font-medium focus:outline-none focus:ring-2 focus:ring-brand-blue/20 resize-none bg-white"
                        />
                    </Field>
                </div>
            </Card>
            ...
            <Card>
                ...
                <div className="flex gap-4">
                    <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" checked={sendNow} onChange={() => setSendNow(true)} className="accent-brand-blue" />
                        <span className="text-sm font-bold text-[#1d1d1f]">Send now</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                        <input type="radio" checked={!sendNow} onChange={() => setSendNow(false)} className="accent-brand-blue" />
