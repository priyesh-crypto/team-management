...
export function PublicFormRenderer({ form }: Props) {
    ...
    const inputClass = "w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-blue/20 transition-colors";
    ...
    return (
        <form onSubmit={handleSubmit} className="px-8 py-6 space-y-5">
            ...
            <button
                type="submit"
                disabled={submitting}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-brand-blue text-white font-black text-sm hover:bg-brand-blue-dark disabled:opacity-50 transition-colors"
            >
