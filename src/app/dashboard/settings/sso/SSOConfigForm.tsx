                    ...
                    <div className="flex gap-2">
                        {["saml", "oidc"].map(p => (
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-lg text-xs font-black transition-colors ${provider === p ? "bg-brand-blue text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"}`}
                            >
                                {p.toUpperCase()}
                            </button>
                        ))}
