    ...
    return (
        <div className="p-8 max-w-5xl space-y-8">
            <div>
                ...
                <p className="text-sm text-slate-400">Authenticate with a Bearer token from <a href="/dashboard/settings/integrations" className="text-brand-blue hover:underline">Settings → Integrations</a>.</p>
            </div>
